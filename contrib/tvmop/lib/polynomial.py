...
@defop(name="cuda_polyval", target="cuda", dtype=['float32', 'float64'])
...
@defop(name="cuda_polyval_horner", target="cuda", dtype=IntegralTypes)
...
@defop(name="cuda_backward_polyval", target="cuda", dtype=['float32', 'float64'],
       req=['kWriteTo', 'kAddTo'], attrs=['req'])
